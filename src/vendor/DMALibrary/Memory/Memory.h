...
public:
	...
	*/
	...
	/**
	 * \brief Retrieves all heap memory regions for the specified process.
	 *
	 * Uses the provided VMM handle (hVMM) to enumerate heap regions for the process with the given PID.
	 * Populates the 'heaps' vector with information about each heap region found.
	 * @param hVMM Handle to the VMM instance.
	 * @param pid Process ID to query.
	 * @param heaps Reference to a vector to receive HeapRegion data.
	 */
	bool GetHeapRegions(std::vector<HeapRegion>& heaps);
};
